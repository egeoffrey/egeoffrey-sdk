...
from sdk.python3.module.helpers.mqtt_client import Mqtt_client
from sdk.python3.module.helpers.scheduler import Scheduler
from sdk.python3.module.helpers.session import Session
...
class Module(threading.Thread, metaclass=ABCMeta):
    ...
    def __init__(self, scope, name):
        ...
        self.gateway_version = int(os.getenv("EGEOFFREY_GATEWAY_VERSION", 1))
        # house settings
    ...
    def __log(self, severity, text, allow_remote_logging):
        if self.logging_local:
            print(sdk.python3.utils.strings.format_log_line(severity, self.fullname, text))
